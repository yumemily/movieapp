                ...
                <div class="flipper">
                    <div class="front">
                        <Card id="cards" className="col-md-12 col-12" style={{ width: '100%', position: 'relative', zIndex: 0 }}>
                            <Badge className='shadow-lg'
                                style={movie.vote_average >= 8 ? badgeGreen : movie.vote_average < 6 ? badgeRed : badgeFront} pill>
                                {movie.vote_average}
                            </Badge>{' '}
                            <Card.Img className="shadow-lg" variant="top"
                    ...
                    <div class="back">
                        <Card id="cards" className="col-md-12 col-12" style={{ width: '100%' }}>
                            ...
                            <Card.Img style={imgStyle} className="shadow-lg" variant="top"
                                src={`https://image.tmdb.org/t/p/w600_and_h900_bestv2/${movie.poster_path}`} />
                            <Card.Body>
                                <Card.Title style={trailerBtnPosition} >
                                    <Button onClick={() => props.openModal(movie.id)} style={trailerBtnStyle}>
